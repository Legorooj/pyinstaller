...
class InvalidModule(Module):
    """
    Node representing a module that could not be
...
class ExcludedModule(BaseNode):
    ...
    def __init__(self, module_name):
        super(ExcludedModule, self).__init__(
            name=module_name,
            loader=None,
            distribution=None,
            filename=None,
...
class MissingModule(BaseNode):
    ...
    def __init__(self, module_name):
        super(MissingModule, self).__init__(
            name=module_name,
            loader=None,
            distribution=None,
            filename=None,
...
class InvalidRelativeImport(BaseNode):
    ...
    def __init__(self, module_name):
        super(InvalidRelativeImport, self).__init__(
            name=module_name,
            loader=None,
            distribution=None,
            filename=None,
